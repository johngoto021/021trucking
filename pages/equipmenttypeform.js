...
export default function EquipmentForm() {
  ...
  useEffect(() => {
    ...
    console.log("equipmentTypeCuid", equipmentTypeId);
    console.log("equipmentTypeName", equipmentTypeName);
    console.log("equipmentTypeActive", equipmentTypeActive);
...
<div className="mt-10 sm:mt-0">
  ...
  <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    <div className="mb-4">
      ...
      <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Name of Equipment Type" />
