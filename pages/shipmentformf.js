  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (createdshipment.status !== 200) {
        ...
        //setShipmentRef(setAPIResponse2.shipmentCuid);
        seeShipments();
  ...
  <div id="accordion-collapse-body-1" className="" aria-labelledby="accordion-collapse-heading-1">
    ...
    {data2?.map((equipmentDD) => (
      ...
      <div className="flex items-center pl-3">
                  ...
                  <label htmlFor="equipmentTypeCuid" className="py-3 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">{equipmentDD.equipmentTypeName}</label>
              </div>
          </li>
    ))}
    </ul>
    ...
    <div className="overflow-hidden shadow sm:rounded-md">
            <div className="bg-white px-4 py-5 sm:p-6">
              ...
              <div className="col-span-4 sm:col-span-3 block text-sm font-medium text-gray-700 my-4">
