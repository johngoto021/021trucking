    ...
    <main>
      ...
      <header className="p-8 grid grid-cols-1 md:grid-cols-2 gap-4 pt-10 lg:px-40 bg-blue-50 dark:bg-blue-900 md:h-96">
        <div className="mx-auto mb-10 md:mt-20">
          <div className="badge bg-yellow-500 inline-block rounded-xl">
          ...
          <h1 className="text-4xl font-bold mt-4 dark:text-gray-50 text-gray-700">
            Lets talk about your shipping needs.
          </h1>
          <p className="text-md text-gray-700 mt-4 font-light px-2">
            Fill the form and send in your queries. A sales rep will respond as soon as possible. Alternatively, You can reach out to us at sales@goto021.com or call us toll free at 1-833-468-6021.
          </p>
        </div>
        <form
      ...
      <section className="">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 mx-2 md:grid-cols-3 gap-3 max-w-6xl md:mx-auto my-10">
          <div className="card p-8 shadow rounded-md flex flex-row items-center space-x-4 hover:cursor-pointer hover:shadow-lg transition duration-200">
            ...
            <p className="text-gray-500 font-light">+1 833 468-6021</p>
          </div>
