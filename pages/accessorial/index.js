...
<h1 className="text-3xl font-bold tracking-tight text-gray-900">Accessorials <span className="text-sm text-blue-600"><Link href="accessorial/create">add new</Link></span></h1>
</div>
</header>
<main>
